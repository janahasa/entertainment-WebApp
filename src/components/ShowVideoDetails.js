...
import { BookMarkedContext } from "../context/BookMarkedContext"; // Update import statement
...
const ShowVideoDetails = () => {
  ...
  const { bookMarkedMovies, indicateBookedMarkedBtn } = useContext(BookMarkedContext); // Update useContext argument
